...
function openSettings(){
  ...
  openModal('<h3>⚙ 設定・記録</h3>'+
    ...
    '<div class="small" style="margin-top:14px">LEXICA(レキシカ) v3.5.2 ─ 英単語×ローグライクRPG<br>単語データ: 英検1級レベル '+WORDS.length+'語(<a href="https://github.com/zuno1000/tango" style="color:var(--accent2)">tango</a> 由来)</div>');
  $("modeToggle").onclick=()=>{
